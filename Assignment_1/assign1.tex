...
\author{ Aditya Garg% <-this % stops a space
\\
CS22BTECH11002	
...
\\ [3pt]
(A)\hspace{4pt}$\displaystyle\frac{2}{3}$ \hspace{5pt}  (B)\hspace{4pt}$-1.5$ \hspace{5pt}   (C)\hspace{4pt}$15\%$ \hspace{5pt}   (D)\hspace{4pt}$0.7$ \hspace{5pt}
\\
\\
%Answer
...
\\
\\
\indent Since $0 \le \displaystyle\frac{2}{3} \le 1$ , From (1)
\\
\\
...
\\
\\
\indent Since $0 \le \displaystyle\frac{15}{100} \le 1$ , From (1)
\\
\\
\indent It can be probability of an event.
\\
...
\\
\\
\indent Since $0 \le 0.7 \le 1$, From (1)
\\
\\
\indent It can be a probability of an event.
