...
Let $Z$ be a Bernoulli random variable
 \begin{equation}
  ...
  \pr{Z=0} &= \pr{Z=1}\\
         &=\frac{1}{2}
  \end{align}
Let $X_1$ be a random variable denoting first ball chosen from Urn 1 \\
 $X_2$ be random variable denoting second ball chosen from Urn 1
...
\begin{table}[ht!]
		...
		\label{table:table1}	
	\end{table}
Let $Y_1$ be a random variable denoting first ball chosen from Urn 2 \\
$Y_2$ be random variable denoting second ball chosen from Urn 2
...
\cbrak{002,020,012,021,102,120,112,121}
\begin{align}
    \pr{E}&=\frac{8}{12}\\
        &=\frac{2}{3} \\
