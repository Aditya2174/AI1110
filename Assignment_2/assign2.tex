...
Since $X$ is a uniformly distributed random variable,
For $x$: \cbrak{0,1,2,3,4,5}
\begin{align}
\pr{X=x} = \frac{1}{6}
\end{align}
\begin{enumerate}[label =(\alph*)]
\item Sample Space S:
\begin{align}
\cbrak{01,10,02,20,12,21,34,43,35,53,45,54}
\end{align} 
\begin{align}
    \therefore n(S) = 12
\end{align}
...
\begin{align}
&\pr{X+Y=1}=\pr{X+Y=7}\\
&\because \pr{X=2,Y=5}=0\\
&\therefore \pr{X+Y=7}=\frac{1}{6} \\
&=1-2\times\frac{1}{6}\\
&=\frac{2}{3}
\end{align}
\begin{align}
